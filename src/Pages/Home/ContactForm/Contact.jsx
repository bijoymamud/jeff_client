...
//       <div className="relative flex items-center justify-center  py-12 sm:py-20 dark:bg-[#030712]">
//         <div className="w-full max-w-6xl">
//           <div className="md:bg-white dark:bg-[#111827] rounded-3xl md:-mt-96  z-[999]  md:p-12 md:shadow-md">
...
//               {/* Right Column - Form */}
//               <div className="-top-40 sm:-top-60 md:-top-80 absulate">
//                 <h2 className="text-3xl sm:text-[36px] font-bold text-gray-900 dark:text-white sm:mb-8 py-10 md:py-0 text-center md:text-start">
//                   Request a Quote
//                 </h2>
...
//                     <div>
//                       <label className="block font-medium text-[16px] text-[#030712] dark:text-white mb-2">
//                         First Name
//                       </label>
//                       <input
//                         type="text"
...
//                         className="w-full px-4 py-3 shadow-md dark:bg-[#030712] rounded-lg border-2 border-white bg-input focus:outline-none focus:ring-0 focus:border-transparent text-[14px]"
//                       />
//                     </div>
//                     <div>
//                       <label className="block font-medium text-[16px] text-[#030712] dark:text-white mb-2">
...
//                           <PiImageSquareThin className="h-[46px] w-[46px]  dark:text-white" />
...
export default function Contact() {
  ...
  return (
    <div id="contact" className="relative w-full dark:bg-[#030712] ">
      <div className="relative z-10 py-20 md:py-32">
        <div className="w-full max-w-6xl mx-auto md:px-4">
          <div className="md:bg-white dark:bg-[#111827] rounded-3xl md:-mt-[500px] -mt-[200px] z-10 md:p-12 md:shadow-md relative">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
              <div className="relative pt-5 md:pt-0">
                <div className="bg-black rounded-2xl p-6 sm:p-8 relative overflow-hidden min-h-full">
                  <div className="absolute -top-5 -left-5 w-[136px] h-[136px] bg-gradient-to-t from-[#00080C] to-[#5F3FA9] rounded-full opacity-80" />
              ...
              {/* Right Column - Form (fixed positioning) */}
              <div className="relative md:-mt-20 lg:-mt-10">
                <h2 className="text-3xl sm:text-[36px] font-bold text-gray-900 dark:text-white md:mb-8 py-10 md:py-10 text-center md:text-start">
                  Request a Quote
                </h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        placeholder="Enter first name"
                        className="w-full px-4 py-3 shadow-md bg-[#FBF9FF] dark:bg-[#FBF9FF] rounded-lg border-2 border-white focus:outline-none focus:ring-0 focus:border-transparent text-[14px]"
                      />
                    </div>
                    <div>
                      <label className="block font-medium text-[16px] text-[#030712] dark:text-white mb-2">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        placeholder="Enter last name"
                        className="w-full px-4 py-3 shadow-md rounded-lg border-2 border-white bg-[#FBF9FF] dark:bg-[#FBF9FF] focus:outline-none focus:ring-0 focus:border-transparent text-[14px]"
                      />
                    </div>
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full bg-input text-title border-2 border-white shadow-md hover:cursor-pointer text-white bg-[#FBF9FF] dark:bg-[#FBF9FF] font-semibold py-3 rounded-lg transition duration-200"
                  >
                    Submit
                  </button>
                </form>
