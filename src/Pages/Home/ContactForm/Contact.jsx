    ...
    <div id="contact" className="relative w-full dark:bg-[#030712] ">
      <div className="relative z-10 py-20 md:py-32">
        <div className="w-full max-w-6xl mx-auto md:px-4">
          <div className="md:dark:bg-[#030712] md:bg-white rounded-3xl md:-mt-[500px] -mt-[200px] z-10 md:p-12 md:shadow-md relative">
              ...
              <div className="relative  md:pt-0">
                <div className="bg-black rounded-2xl p-6 sm:p-8 relative overflow-hidden min-h-full">
                  ...
                  <div className="relative z-10 md:pt-20">
                    <h2 className="md:text-[30px] text-[20px] font-bold text-white mb-3">
                      Contact Information
                    </h2>
