...
// import { useGetTestimonialsQuery } from "@/redux/features/baseApi";
...
//   const { data: testimonialResponse } = useGetTestimonialsQuery();
//   const testimonialsData = testimonialResponse?.data;
//   console.log(testimonialsData, "dataaaa");
...
export default function Testimonials() {
  ...
  const translateValue =
    totalSlides > 0 ? -(currentIndex * (100 / slidesToShow)) : 0;
